...
<body style="margin-top:0px;margin-left:0px">
    <form id="form1" runat="server">
       ...
       <div style="position:absolute; top: 86px; left: 860px; width: 367px; height: 501px; margin-top: 1px; border-radius:10px 10px; background-color:#ffbf40">
           ...
           <div style="color:white; font-size:14px; font-weight:bold" class="auto-style3">Şifrenizi mi unuttunuz ?</div>
          
           <div class="auto-style1" >
               <asp:Button ID="btnadmingiris" runat="server" CssClass="btn btn-dark" PostBackUrl="~/WebForm1.aspx" Text="Giriş Yap" Width="144px" />
            </div>
           <div style="color:black; font-weight:bold; " class="auto-style2"><a href="KullaniciLogin.aspx">Kullanıcı Giriş</a></div>
       </div>
